 ...
 * @author Nacos
 */
public class MyNacosException extends Exception {
    ...
    public MyNacosException() {
    }
    
    public MyNacosException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }
    
    public MyNacosException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }
    
    public MyNacosException(final int errCode, final String errMsg, final Throwable throwable) {
